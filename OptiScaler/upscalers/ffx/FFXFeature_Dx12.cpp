...
bool FFXFeatureDx12::EvaluateInternal(ID3D12GraphicsCommandList* InCommandList, NVSDK_NGX_Parameter* InParameters)
{
    ...
    if (probe.sampled && probe.list == InCommandList)
        LOG_INFO("lmxxf probe FSR: eval={} copied={} replacement={} expected={} paramColor={} dispatchColor={} "
                 "identityMatch={} mv={} depth={} render={}x{} jitter={},{} mode={} epoch={} age={} srcSeq={} "
                 "priming={} (CPU binding, not pixel proof)",
                 ...
                 params.motionVectors.resource, params.depth.resource, params.renderSize.width,
                 params.renderSize.height, params.jitterOffset.x, params.jitterOffset.y, static_cast<int>(probe.mode),
                 probe.epoch, probe.age, probe.sourceSequence, probe.priming);
