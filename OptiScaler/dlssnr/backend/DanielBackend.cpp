...
{
DanielBackend::DanielBackend(ID3D12Device* device, ID3D12CommandQueue* queue, const std::filesystem::path& directory)
...
bool DanielBackend::GraphicsRestartNeeded(UINT activePasses) const { return inner.GraphicsRestartNeeded(activePasses); }
} // namespace DlssNr::Backend
