...
if %errorlevel%==0 (
  ...
  cl /nologo /std:c++17 /O2 /LD /EHsc /DNOMINMAX /D_WIN32_WINNT=0x0A00 /DLMXXF_NR_RUNTIME_EXPORTS ^
    ...
    "OptiScaler\dlssnr\backend\lmxxf_runtime\LmxxfNrRuntime.cpp" ^
...
"%LMXXF_GXX%" -std=c++17 -O2 -shared -static -static-libgcc -static-libstdc++ -D_WIN32_WINNT=0x0A00 -DLMXXF_NR_RUNTIME_EXPORTS -I "OptiScaler\dlssnr\backend\lmxxf_runtime" -I "third_party\lmxxf\src" -I "third_party\lmxxf\Development\HIP" "OptiScaler\dlssnr\backend\lmxxf_runtime\LmxxfNrRuntime.cpp" -o "%OUT%\LmxxfNrRuntime.dll" -Wl,--out-implib,"%OUT%\LmxxfNrRuntime.dll.a" -ld3d12 -ldxgi -ld3dcompiler -ldxguid
