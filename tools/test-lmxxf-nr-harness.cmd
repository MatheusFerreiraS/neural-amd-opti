...
cl /nologo /std:c++20 /EHsc /W4 /utf-8 tests\lmxxf_nr_gpu.cpp /I OptiScaler\dlssnr\backend\lmxxf_runtime /Fe"%OUT%\lmxxf_nr_gpu.exe" /Fo"%OUT%\lmxxf_nr_gpu.obj" /link d3d12.lib dxgi.lib
if not %errorlevel%==0 exit /b 1
